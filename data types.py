...
def translate_now():
    ...
    try:
        ...
        c3=combo2.get()
        if(text_):
            lan = t.detect(text=text_).lang
            words=pytarjimon.tarjima(text_, c3)
...
#icon
image_icon=PhotoImage(file="Google Translator.png.png")
root.iconphoto(False,image_icon)

#arrow
arrow_image=PhotoImage(file="arrow.png.png")
